...
function Platform() {
	...
	if (score >= 5000) this.types = [3, 3, 3, 3, 3, 3, 3, 3];
	else if (score >= 2000 && score < 5000) this.types = [3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3];
	else if (score >= 1000 && score < 2000) this.types = [4, 4, 4, 4, 4, 3, 3, 3, 3];
