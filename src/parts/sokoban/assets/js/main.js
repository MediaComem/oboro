...
ImageLoader.init(new Array("./parts/sokoban/assets/img/textures/ground.png","./parts/sokoban/assets/img/textures/wall.png","./parts/sokoban/assets/img/textures/stone2.png"),mapTilesLoaded);
...
function loadPlayerTiles(){
    ...
    playerTileSet.src = "./parts/sokoban/assets/img/my_sprites_charset.png";
...
*/
  ...
  if( /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ) {
     ...
     //alert('mobile')
     $('head').append('<link rel=\"stylesheet\" href=\"./parts/sokoban/mqmobile.css\" />')
